...
public class MainActivityTest {
    ...
    public void checkIfClickingOnItWillTakeMeToDetailsActivity() throws InterruptedException {
        onView(withId(R.id.recycler_view)).check(matches(isClickable())).perform(click());
    }

    @Test
    public void checkIfForecastItemIsDisplayedOnForecastAdapter()
            throws InterruptedException {
        onData(anything()).inAdapterView(withId(R.id.recycler_view)).atPosition(TEST_POSITION).
